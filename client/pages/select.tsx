...
export default function Select() {
  ...
  return (
    <div className="express-p2p-page min-h-screen bg-gradient-to-br from-[#1a2847] via-[#16223a] to-[#0f1520] text-white relative overflow-hidden flex items-center justify-center">
      ...
      <div className="w-full mx-auto px-4 sm:px-6 relative z-20 space-y-8 sm:space-y-12 flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 pt-4 w-full sm:w-auto">
          <Button
            onClick={() => navigate("/buy-now")}
            className="flex-1 sm:flex-none px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-gradient-to-r from-[#FF7A5C] to-[#FF5A8C] hover:shadow-2xl hover:scale-105 transition-all duration-300 text-white font-semibold text-base sm:text-lg shadow-lg active:scale-95"
          >
            buy
          </Button>
          ...
          <Button
            ...
            className="flex-1 sm:flex-none px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-gradient-to-r from-[#FF5A8C] to-[#FF7A5C] hover:shadow-2xl hover:scale-105 transition-all duration-300 text-white font-semibold text-base sm:text-lg shadow-lg active:scale-95"
          >
            sell
          </Button>
        </div>
