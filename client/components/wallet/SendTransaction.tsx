              ...
              {step === "form" ? (
                <>
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger className="w-full bg-transparent border border-gray-700 text-white placeholder:text-gray-400 uppercase rounded-none">
                        <SelectValue placeholder="SELECT TOKEN" />
                      </SelectTrigger>
                      <SelectContent className="bg-gray-800 border border-gray-700 text-white rounded-none">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="font-mono text-sm bg-transparent border border-gray-700 text-white caret-white placeholder:text-gray-300 placeholder:text-muted-foreground rounded-none"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-transparent border border-gray-700 text-white caret-white placeholder:text-gray-300 placeholder:text-muted-foreground rounded-none"
                    />
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="bg-[#064e3b]/50 border border-[#22c55e]/30 text-white hover:bg-[#16a34a]/20 uppercase rounded-[4px]"
                      >
                        25%
                      </Button>
                      <Button
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-[#22c55e] to-[#16a34a] hover:from-[#1ea853] hover:to-[#15803d] text-white shadow-lg uppercase rounded-[4px]"
                ...
                <>
                  ...
                  <div className="flex gap-3">
                    <Button
                      ...
                      className="flex-1 bg-[#064e3b]/50 border border-[#22c55e]/30 text-white hover:bg-[#16a34a]/20 uppercase rounded-[4px]"
                      disabled={isLoading}
                    >
                      Back
                    </Button>
                    <Button
                      ...
                      className="flex-1 bg-gradient-to-r from-[#22c55e] to-[#16a34a] hover:from-[#1ea853] hover:to-[#15803d] text-white shadow-lg uppercase rounded-[4px]"
                      disabled={isLoading}
                    >
