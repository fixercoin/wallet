  ...
  return (
    <div className="express-p2p-page min-h-screen bg-gradient-to-br from-[#2d1b47] via-[#1f0f3d] to-[#0f1820] text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto px-4 py-2 relative z-20">
        {/* Balance Section */}
        <div className="mb-3 rounded-lg p-6 border border-[#22c55e]/40 bg-gradient-to-br from-[#2d1b47]/60 to-[#1f0f3d]/60">
          <TopBar
        ...
        <div className="space-y-3">
          {sortedTokens.map((token) => {
            ...
            return (
              <Card
                key={token.mint}
                className="bg-gradient-to-br from-[#2d1b47]/60 to-[#1f0f3d]/60 backdrop-blur-xl border border-[#22c55e]/30 rounded-md"
              >
