      ...
      <div className="max-w-md mx-auto px-4 py-6 relative z-20">
        <Card className="bg-transparent backdrop-blur-xl rounded-md">
          <CardContent className="space-y-6 pt-6">
            <div>
              <label className="block font-medium text-white/80 mb-2">Send transaction to this wallet</label>
              <div className="p-4 rounded-lg bg-[#1a2540]/50 border border-[#FF7A5C]/30 text-white flex items-center justify-between gap-2">
                <code className="font-mono text-xs break-all">{ADMIN_WALLET}</code>
                <Button variant="ghost" size="icon" onClick={copyAddress} aria-label="Copy address" className="text-white">
            ...
            <div>
              ...
              <div className="p-4 rounded-lg bg-[#1a2540]/50 border border-[#FF7A5C]/30 text-white space-y-2">
                ...
                <div className="flex items-center justify-between text-sm"><span className="opacity-80">Amount Tokens</span><span className="font-semibold">{order.amountTokens.toFixed(6)} {order.token}</span></div>
                ...
                <div className="flex items-center justify-between text-sm"><span className="opacity-80">You Will Receive</span><span className="font-semibold">{estimatedPKR.toFixed(2)} PKR</span></div>
              </div>
            </div>
