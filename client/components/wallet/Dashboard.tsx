                      ...
                      return (
                        <div className="flex items-center justify-between gap-4 w-full">
                          ...
                          <Button
                            ...
                            className="bg-[#86efac] hover:bg-[#65e8ac] border border-[#22c55e]/40 text-gray-900 font-bold text-xs pl-4 pr-10 py-2.5 rounded-sm whitespace-nowrap h-auto transition-colors"
                          >
                            P2P TRADE
                          </Button>
                        </div>
