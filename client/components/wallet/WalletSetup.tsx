              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Button
                    ...
                    disabled={isLoading}
                    className="w-full h-12 rounded-[1.75px] font-semibold bg-gradient-to-r from-[#16a34a] to-[#22c55e] hover:from-[#15803d] hover:to-[#16a34a] text-white shadow-lg hover:shadow-2xl transition-all"
                  >
                    CREATE NEW WALLET
                  </Button>
                ...
                <div>
                  {recoverMode === "mnemonic" ? (
                    <Button
                      ...
                      className="w-full h-12 rounded-[1.75px] font-semibold uppercase bg-gradient-to-r from-[#16a34a] to-[#22c55e] hover:from-[#15803d] hover:to-[#16a34a] text-white shadow-lg hover:shadow-2xl transition-all"
                    >
                      Recover Wallet
                    </Button>
                  ) : (
