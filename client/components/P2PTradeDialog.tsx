    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#1a2847] border border-gray-300/30 text-white max-w-md">
        ...
        <div className="space-y-4">
          ...
          {/* Primary Input - Changes based on order type */}
          {orderType === "SELL" ? (
            <>
              {/* For SELL: Ask for Token amount first */}
              <div>
                <label className="block text-xs font-semibold text-white/80 uppercase mb-2">
                  Amount ({defaultToken})
                </label>
            ...
            <>
              {/* For BUY: Ask for PKR amount first */}
              <div>
                <label className="block text-xs font-semibold text-white/80 uppercase mb-2">
                  Amount (PKR)
                </label>
              ...
              {/* For BUY: Show estimated token amount */}
              <div>
                <label className="block text-xs font-semibold text-white/80 uppercase mb-2">
                ...
                <div className="px-4 py-3 rounded-lg bg-[#1a2540]/50 border border-gray-300/20 text-white/90 font-semibold">
                  {amountTokens
                    ? parseFloat(amountTokens).toFixed(6)
                    : "0.000000"}{" "}
                  {defaultToken}
                </div>
              </div>
