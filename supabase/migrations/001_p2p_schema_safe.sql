-- Drop existing tables and policies if they exist (for safe re-execution)
DROP POLICY IF EXISTS "Users can delete their own notifications" ON p2p_notifications;
DROP POLICY IF EXISTS "Users can update their own notifications" ON p2p_notifications;
DROP POLICY IF EXISTS "Users can view their own notifications" ON p2p_notifications;
DROP POLICY IF EXISTS "Dispute parties can update dispute" ON p2p_disputes;
DROP POLICY IF EXISTS "Users can create disputes" ON p2p_disputes;
DROP POLICY IF EXISTS "Dispute parties can view dispute details" ON p2p_disputes;
DROP POLICY IF EXISTS "Escrow parties can update escrow" ON p2p_escrow;
DROP POLICY IF EXISTS "Escrow parties can view escrow details" ON p2p_escrow;
DROP POLICY IF EXISTS "Users can update their own orders" ON p2p_orders;
DROP POLICY IF EXISTS "Users can insert their own orders" ON p2p_orders;
DROP POLICY IF EXISTS "Orders are viewable by everyone" ON p2p_orders;
DROP POLICY IF EXISTS "Users can delete their own payment methods" ON p2p_payment_methods;
DROP POLICY IF EXISTS "Users can update their own payment methods" ON p2p_payment_methods;
DROP POLICY IF EXISTS "Users can insert their own payment methods" ON p2p_payment_methods;
DROP POLICY IF EXISTS "Users can view their own payment methods" ON p2p_payment_methods;
DROP POLICY IF EXISTS "Users can insert their own profile" ON profiles;
DROP POLICY IF EXISTS "Users can update their own profile" ON profiles;
DROP POLICY IF EXISTS "Profiles are viewable by everyone" ON profiles;

DROP TABLE IF EXISTS p2p_notifications CASCADE;
DROP TABLE IF EXISTS p2p_disputes CASCADE;
DROP TABLE IF EXISTS p2p_escrow CASCADE;
...
CREATE TABLE IF NOT EXISTS p2p_disputes (
  ...
  resolution_recipient VARCHAR(88),
