      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-2xl overflow-hidden">
          <div className="p-5 space-y-4">
            {/* FROM row */}
            <div className="bg-purple-100/40 rounded-xl p-4">
              <div className="flex items-center justify-between">
                <div className="flex-1 pr-3">
                  <Input
                    ...
                    className="w-full bg-transparent border-0 p-0 h-auto text-2xl font-bold leading-none tracking-tight text-[hsl(var(--foreground))] placeholder:text-[hsl(var(--muted-foreground))] focus-visible:ring-0"
                  />
