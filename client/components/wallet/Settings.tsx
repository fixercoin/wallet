              ...
              <section>
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    variant="default"
                    className="w-3/4 sm:w-1/2 mx-auto flex items-center gap-2 justify-center bg-green-600 hover:bg-green-700 text-white rounded-none"
                  >
                  ...
                  <Button
                    ...
                    variant="default"
                    className={`w-3/4 sm:w-1/2 mx-auto flex items-center gap-2 justify-center rounded-none ${
                      confirmDelete
