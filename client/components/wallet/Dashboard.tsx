                  ...
                  <CardContent className="w-full p-0">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        isFinite(token.priceChange24h) ? (
                          <Button
                            className={`h-auto px-2 py-0.5 rounded-md font-medium text-xs bg-transparent hover:bg-white/10 border-[3px] transition-colors ${token.priceChange24h >= 0 ? "border-green-400 text-green-400 hover:text-green-300" : "border-red-400 text-red-400 hover:text-red-300"}`}
                            variant="ghost"
                          >
