      ...
      <div className="w-full lg:max-w-4xl mx-auto px-0 sm:px-4 md:px-6 lg:px-8 py-2 relative z-20">
        ...
        <div className="w-full mt-6 mb-1 rounded-none sm:rounded-lg p-4 sm:p-6 border-0 bg-gradient-to-br from-[#ffffff] via-[#f0fff4] to-[#a7f3d0] relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-10 w-full">
            <Button
              onClick={onSend}
              className="flex-1 min-w-[80px] sm:min-w-[100px] h-10 rounded-sm font-semibold text-xs bg-[#064e3b]/50 hover:bg-[#16a34a]/20 border border-[#22c55e]/30 text-white flex items-center justify-center"
            >
              SEND
            </Button>
            ...
            <Button
              onClick={onReceive}
              className="flex-1 min-w-[80px] sm:min-w-[100px] h-10 rounded-sm font-semibold text-xs bg-[#064e3b]/50 hover:bg-[#22c55e]/20 border border-[#22c55e]/30 text-white flex items-center justify-center"
            >
              RECEIVE
            </Button>
