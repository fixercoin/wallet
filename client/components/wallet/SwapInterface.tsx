              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 pr-3">
                  <Input
                    ...
                    className="w-full bg-transparent border-0 p-0 h-auto text-3xl leading-none tracking-tight text-[hsl(var(--foreground))] placeholder:text-[hsl(var(--muted-foreground))] focus-visible:ring-0"
                  />
