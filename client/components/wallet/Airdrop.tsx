          ...
          <div className="space-y-4 mt-6">
            <div>
              ...
              <Select value={selectedMint} onValueChange={setSelectedMint}>
                <SelectTrigger className="w-full bg-transparent text-gray-900 border border-gray-400/30 placeholder:text-gray-500 mt-2">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-2">
                <Input
                  ...
                  inputMode="decimal"
                  pattern="^[0-9]*[.]?[0-9]*$"
                  className="flex-1 bg-transparent border border-gray-400/30 text-gray-900 placeholder:text-gray-500"
            ...
            <div>
              ...
              <textarea
                className="w-full mt-2 p-2 bg-transparent text-gray-900 rounded-md h-40 font-mono text-sm border border-gray-400/30 placeholder:text-gray-500"
